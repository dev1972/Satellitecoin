...
This means one can have an always-on stlld instance running, and another local stlld/stll-qt instance which connects to this node and receives blocks from it.
