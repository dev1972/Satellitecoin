...
In order to support loading of multiple wallets in stll-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stll.cpp.
...
Changes to stll.cpp
----------------------
stll.cpp is the entry point into stll-qt, and as such, will require some minor modifications to provide hooks for
