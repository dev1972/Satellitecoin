...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/dev1972/Satellitecoinblob/master/doc/translation_process.md#synchronising-translations).
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/dev1972/Satellitecoinreleases/new) with a link to the archived release notes.
