                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("STLL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STLL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stll: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About STLL Core"), this);
    aboutAction->setStatusTip(tr("Show information about STLL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STLL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STLL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STLL addresses"));
    ...
    openAction->setStatusTip(tr("Open a STLL: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the STLL Core help message to get a list with possible STLL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("STLL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STLL network", "", count));
}
...
{
    QString strTitle = tr("STLL Core"); // default title
