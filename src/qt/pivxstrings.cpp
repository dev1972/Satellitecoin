...
static const char UNUSED* pivx_strings[] = {
    ...
    QT_TRANSLATE_NOOP("pivx-core", "Copyright (C) 2015-%i The STLL Core Developers"),
    ...
    QT_TRANSLATE_NOOP("pivx-core", "Error loading wallet.dat: Wallet requires newer version of STLL Core"),
    ...
    QT_TRANSLATE_NOOP("pivx-core", "Initialization sanity check failed. STLL Core is shutting down."),
    ...
    QT_TRANSLATE_NOOP("pivx-core", "Wallet needed to be rewritten: restart STLL Core to complete"),
